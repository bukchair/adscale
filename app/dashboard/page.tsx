          ...
          <>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(3,1fr)", gap: 14 }}>
              {[
                ...
                { name: "עזבו עגלה", size: "3,401", platforms: ["meta","tiktok"], c: "#f5a623", icon: "???" },
                { name: "Lookalike רוכשים 3%", size: "82,000", platforms: ["meta"], c: "#00d4aa", icon: "??" },
                { name: "צפו במוצר 3+ פעמים", size: "2,190", platforms: ["google","meta","tiktok"], c: "#ff6b6b", icon: "???" },
          ...
          <>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 14 }}>
              {[
                ...
                { name: "Google Merchant Center", ok: false, icon: "???", key: "GMC_MERCHANT_ID", detail: "פיד מוצרים" },
              ].map((c, i) => (
